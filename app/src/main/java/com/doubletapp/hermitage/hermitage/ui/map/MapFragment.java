...
//        tileView.addDetailLevel(1f, "tiles/1000/tile-%d-%d.png", 32, 32);
    ...
    private void initData() {
        Pass point0 = new Pass(736, 272); // Oval
        Pass point1 = new Pass(800, 416); // Oval Copy 11
        Pass point2 = new Pass(864, 416); // Oval Copy 12
        Pass point3 = new Pass(1396, 496); // Oval Copy 16
        Pass point4 = new Pass(1204, 416); // Oval Copy 18
        Pass point5 = new Pass(1268, 496); // Oval Copy 21
        Pass point6 = new Pass(520, 272); // Oval Copy
        Pass point7 = new Pass(384, 272); // Oval Copy 2
        Pass point8 = new Pass(284, 348); // Oval Copy 3
        Pass point9 = new Pass(284, 460); // Oval Copy 4
        Pass point10 = new Pass(284, 568); // Oval Copy 4
        Pass point11 = new Pass(428, 600); // Oval Copy 5
        Pass point12 = new Pass(496, 600); // Oval Copy 6
        Pass point13 = new Pass(516, 636); // Oval Copy 7
        Pass point14 = new Pass(516, 676); // Oval Copy 8
        Pass point15 = new Pass(516, 764); // Oval Copy 9
        Pass point16 = new Pass(516, 852); // Oval Copy 10
        Pass point17 = new Pass(588, 916); // Oval Copy 13
        Pass point18 = new Pass(668, 916); // Oval Copy 14
        Pass point19 = new Pass(700, 968); // Oval Copy 17
        Pass point20 = new Pass(700, 1184); // Oval Copy 35
        Pass point21 = new Pass(732, 1264); // Oval Copy 69
        Pass point22 = new Pass(840, 1180); // Oval Copy 20
        Pass point23 = new Pass(840, 1340); // Oval Copy 22
        Pass point24 = new Pass(840, 1460); // Oval Copy 23
        Pass point25 = new Pass(840, 1520); // Oval Copy 24
        Pass point26 = new Pass(840, 1572); // Oval Copy 25
        Pass point27 = new Pass(840, 1688); // Oval Copy 26
        Pass point28 = new Pass(732, 1724); // Oval Copy 32
        Pass point29 = new Pass(732, 1788); // Oval Copy 36
        Pass point30 = new Pass(808, 1788); // Oval Copy 39
        Pass point31 = new Pass(940, 1788); // Oval Copy 40
        Pass point32 = new Pass(992, 1788); // Oval Copy 41
        Pass point33 = new Pass(1020, 1844); // Oval Copy 42
        Pass point34 = new Pass(1020, 1900); // Oval Copy 43
        Pass point35 = new Pass(1020, 1988); // Oval Copy 44
        Pass point36 = new Pass(1020, 2088); // Oval Copy 45
        Pass point37 = new Pass(1036, 2120); // Oval Copy 47
        Pass point38 = new Pass(1080, 2176); // Oval Copy 49
        Pass point39 = new Pass(1112, 2196); // Oval Copy 51
        Pass point40 = new Pass(1160, 2196); // Oval Copy 52
        Pass point41 = new Pass(1160, 2120); // Oval Copy 50
        Pass point42 = new Pass(968, 2088); // Oval Copy 46
        Pass point43 = new Pass(944, 2124); // Oval Copy 48
        Pass point44 = new Pass(916, 2084); // Oval Copy 53
        Pass point45 = new Pass(720, 2064); // Oval Copy 54
        Pass point46 = new Pass(704, 2160); // Oval Copy 55
        Pass point47 = new Pass(620, 2280); // Oval Copy 56
        Pass point48 = new Pass(548, 2280); // Oval Copy 58
        Pass point49 = new Pass(476, 2280); // Oval Copy 59
        Pass point50 = new Pass(416, 2236); // Oval Copy 60
        Pass point51 = new Pass(300, 2236); // Oval Copy 61
        Pass point52 = new Pass(276, 2164); // Oval Copy 62
        Pass point53 = new Pass(280, 2040); // Oval Copy 63
        Pass point54 = new Pass(284, 1932); // Oval Copy 64
        Pass point55 = new Pass(372, 1920); // Oval Copy 65
        Pass point56 = new Pass(460, 1920); // Oval Copy 66
        Pass point57 = new Pass(552, 1884); // Oval Copy 67
        Pass point58 = new Pass(552, 1848); // Oval Copy 68
        Pass point59 = new Pass(640, 2236); // Oval Copy 57
        Pass point60 = new Pass(672, 1788); // Oval Copy 37
        Pass point61 = new Pass(608, 1788); // Oval Copy 38
        Pass point62 = new Pass(700, 1516); // Oval Copy 33
        Pass point63 = new Pass(700, 1344); // Oval Copy 34
        Pass point64 = new Pass(732, 636); // Oval r1_01
        Pass point65 = new Pass(832, 448); // Oval r1 Copy
        Pass point66 = new Pass(836, 572); // Oval r1 Copy 2
        Pass point67 = new Pass(668, 1016); // Oval Copy 15
