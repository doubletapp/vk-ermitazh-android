...
public class SplashActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        Room room6 = new Room(114, 213, point20);
        Room room7 = new Room(114, 260, point21, point63);
        Room room8 = new Room(114, 331.5, point28, point29, point62);
        ...
        Room room19 = new Room(77, 395, point57, point58);
        Room room20 = new Room(76.5, 411, point57);
        Room room23 = new Room(16.5, 422, point54);
        ...
        Room room40 = new Room(187, 488, point38);
        ...
        Room room45 = new Room(181, 425, point33, point34, point35, point36, point42);
        Room room49 = new Room(128.5, 77.5, point66);
        Room room50 = new Room(197.5, 46.5, point4);
        Room room51 = new Room(248.5, 56.5, point5);
        Room room53 = new Room(52.5, 17, point6);
        Room room54 = new Room(18.5, 16, point7, point8);
        Room room55 = new Room(18, 45.5, point9);
        Room room56 = new Room(18, 73.5, point10);
        Room room58 = new Room(55.5, 95.5, point13, point14);
        Room room62 = new Room(72.5, 147, point16);
        Room room63 = new Room(72.5, 172, point17);
        Room room64 = new Room(97, 172, point18, point19, point67);
        Room room65 = new Room(85, 197.5, point67);
    }
}
